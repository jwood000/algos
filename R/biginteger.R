...
multPolyQuadSieve <- function(m, m2, n, fb) .Call("QuadraticSieveContainer", m, m2, n, fb, PACKAGE = "algos")
quadResidue <- function(n, p) .Call("QuadraticResidueContainer", n, p, PACKAGE = "algos")
