...
.as.char.bigz <-
    as.character.bigz <-
    function(x, b = 10L, ...) .Call("biginteger_as_character", x, b, PACKAGE = "algos")
...
as.double.bigz  <- function(x,...) .Call("biginteger_as_numeric", x, PACKAGE = "algos")
as.integer.bigz <- function(x,...) .Call("biginteger_as_integer", x, PACKAGE = "algos")

.bigz2num <- function(x) {
    r <- .Call("biginteger_as_numeric", x, PACKAGE = "algos")
    if(!is.null(d <- dim(x))) dim(r) <- d
    r
}
setMethod("asNumeric", "bigz", .bigz2num)

length.bigz <- function(x) .Call("biginteger_length", x, PACKAGE = "algos")

"length<-.bigz"<- function(x, value) .Call("biginteger_setlength", x, value, PACKAGE = "algos")
...
getDivisors <- function(n) .Call("getDivisorsC", n, PACKAGE = "algos")
primeFactorization <- function(n) .Call("factorR", n, PACKAGE = "algos")
quadraticSieve <- function(a) .Call("QuadraticSieveContainer", a, PACKAGE = "algos")
quadraticResidue <- function(n, p) .Call("QuadraticResidueContainer", n, p, PACKAGE = "algos")
